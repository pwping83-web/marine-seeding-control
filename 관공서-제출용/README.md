...
**연못 → 호수 → 강 → 바다** 순으로 아두이노·웹 연동을 시험한다는 **세부계획서(샘플)** 는 [`docs/`](./docs/) 폴더에 있습니다. 제출 시 기술 요약과 함께 묶으려면 같은 폴더의 [`관공서_설명용_해상종자살포_단말·연동요약.md`](./docs/관공서_설명용_해상종자살포_단말·연동요약.md) · **[`기술-요구사항-정의/`](./docs/기술-요구사항-정의/README.md)** (요구사항·실시예 초안) 과 대조하세요. 전체 문서 목차는 저장소 [`docs/README.md`](../docs/README.md) 를 참고하세요.
