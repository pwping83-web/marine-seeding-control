...
**이메일·관공서로 보낼 파일만 골라 쓰려면:** [`이메일-첨부-권장패키지/README.md`](./이메일-첨부-권장패키지/README.md) — 첨부해도 되는 문서 목록과 **넣지 말 것**을 구분해 두었습니다.

## 문서(시험·실증 계획)

**연못 → 호수 → 강 → 바다** 순으로 아두이노·웹 연동을 시험한다는 **세부계획서(샘플)** 는 [`docs/`](./docs/) 폴더에 있습니다. 제출 시 기술 요약과 함께 묶으려면 같은 폴더의 [`관공서_설명용_해상종자살포_단말·연동요약.md`](./docs/관공서_설명용_해상종자살포_단말·연동요약.md) 와 대조하세요. 전체 문서 목차는 저장소 [`docs/README.md`](../docs/README.md) 를 참고하세요.
